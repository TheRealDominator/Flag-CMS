...
<html lang="en-EN">
	...
	<div class="collapse navbar-collapse">
		...
		<div class="btn pull-right">
			<a href="pages/signin.php"><button type="button" class="btn btn-default">Sign in</button></a>
			<a href="pages/register.php"><button type="button" class="btn btn-primary">Register</button></a>
		</div>
  ...
  <div class="jumbotron text-center">
    ...
    <p><a class="btn btn-large btn-success" href="pages/register.php">Register now</a></p>
  </div>
